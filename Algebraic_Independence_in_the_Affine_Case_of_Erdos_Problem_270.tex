...
We first prove the transcendence assertion for every admissible intercept. The same hypergeometric framework will then be used to determine all algebraic relations at each fixed slope.
